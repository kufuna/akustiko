...
<head>
    ...
    <?php
    foreach ($data->alternates as $key => $link) {
        if ($key == Lang::$lang) continue; ?>
    ...
    <link rel="stylesheet" href="css/kfn.css">
    <link rel="stylesheet" href="css/general/lightgallery.min.css">
...
<script src="//maps.googleapis.com/maps/api/js?key=" async="" defer="defer"

...
<div class="prompt_back prompt_back_<?= $cfg->id ?>">
  <div class="prompt">
    <div class="formRow form-group"><label>Apartment Number:</label><input type="text" placeholder="" value="" class="form-control"></div>
    <button type="button" name="post" class="buttonS bBlue btn btn-default">Enter</button>
  </div>
</div>
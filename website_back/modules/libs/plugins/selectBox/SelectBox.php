<?php
class P_SelectBox extends Plugin {
  ...
  private function renderOptions() {
    ...
    foreach($this->modules as $mod) {
      ...
      $selected = $mod->{$cfg->optionValue} == $this->cfg->value ? ' selected="selected"' : '';
  ...
  protected function parseConfig($cfg) {
    ...
    $defaults = array(
      ...
      'placeholder' => '',
      'value' => '',
      'field_name' => 'plugin_selectbox_'.$uniqInc,
      'id' => 'plugin_selectbox_id_'.$uniqInc,
      'required' => false,
      'escape' => array(),

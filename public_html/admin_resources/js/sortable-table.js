function initSortable(selector, onChange) {
  var moving = false;
  var moved = false;
  var startX = null;
  var startY = null;
  ...
  $(document).mouseup(function(e) {
    ...
    moving.css({ left: 0, top: 0, zIndex: 0, position: 'static', width: 'auto', height: 'auto', border: '1px solid #dadada' });
    (function(el) {
      setTimeout(function() {
  ...
  function drag(e) {
    ...
    moving.css({ left: 40, top: startOffset.top + diffY, zIndex: 10, position: 'absolute', width: '700px', height: '125px', border: '1px solid #888' })

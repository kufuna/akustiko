...
function sendparamsdir($dir=false){
    ...
    $data = array(
        ...
        "upload.chunk_size"=>"50MB",
        "upload.extensions"=>$types
    );
    return $data;
}

function sendparamsfile($path,$size,$modify,$file=false, $insert = false){
    global $uploaddir;
    global $url;
    ...
    $data = array(      //��� ���� ����� ��������� ���������� ����� thumbnails
        ...
        "canPreview"=>false,
        "exists"=>true,
        "meta"=>array("url"=>$realPath, "thumb_url"=>$realPath),
        "info"=>array(""=>"")
    );
    return $data;
}

(function(e, t) {
    ...
    var s = {},
        ...
        S = "moxman/ui/DragHelper",
        k = "moxman/ui/Scrollable",
        D = "moxman/ui/Panel",
        F = "moxman/ui/Resizable",
        I = "moxman/ui/FloatPanel",
        M = "moxman/ui/KeyboardNavigation",
        H = "moxman/ui/ColorButton",
        N = "moxman/ui/ComboBox",
        O = "moxman/ui/FormItem",
        P = "moxman/ui/Form",
        ...
        Mt = "moxman/ui/Slider",
        Ht = "moxman/ui/Spacer",
        Nt = "moxman/ui/SplitButton",
        Ot = "moxman/ui/StackLayout",
        Pt = "moxman/ui/TabPanel",
        ...
        jt = "moxman/ui/View",
        qt = "moxman/ui/ViewPort",
        Vt = "moxman/util/DateFormatter",
        ...
        yn = "moxman/views/UploadView",
        xn = "moxman/views/ZipView",
        ...
        An = "moxie/core/JSON",
        Sn = "moxie/runtime/html5/xhr/XMLHttpRequest",
        kn = "moxie/runtime/flash/Runtime",
        ...
        Hn = "moxie/runtime/flash/file/FileReaderSync";
    i(l, [], function() {
        return {
        ...
        function o() {
            ...
            u = a + (+new Date).toString(32), d = "onmouseenter" in document.documentElement, c = "onfocusin" in document.documentElement, f = {
                ...
                if (n && 3 !== n.nodeType && 8 !== n.nodeType) {
                    for (n[u] ? g = n[u] : (g = l++, n[u] = g, s[g] = {}), h = h || n, a = a.split(" "), y = a.length; y--;) x = a[y], w = m, b = _ = !1, "DOMContentLoaded" === x && (x = "ready"), o.domLoaded && "ready" === x ? p.call(h, i({
                        type: x
                    })) : (d || (b = f[x], b && (w = function(e) {
                        var n, r;
        ...
        return {
            ...
            moveTo: function(e, t) {
                var n = this;
                return n._rendered ? n.layoutRect({
                    x: e,
                    y: t
                }).repaint() : (n.settings.x = e, n.settings.y = t), n
            }
        }
        ...
        return e.extend({
            recalc: function(e) {
                var t, n, i, r, o, a, s, l, u, c, d, f, p, h, m, g, v = [],
                    y, x, b, w, _, E, C, R, T, A, S, k, D, F, I, M, H, N, O, P, L, W, z, B, U = Math.max,
                    j = Math.min;
        ...
        return e.extend({
            recalc: function(e) {
                var t = e.settings,
                    n, i, r, o, a, s, l, u, c, d, f, p, h, m, g, v, y, x, b, w, _, E, C = [],
                    R = [],
                    T, A, S, k, D, F;
        ...
        return function(r) {
            ...
            function T(e, t, n, i, o, a) {
                ...
                var l, u, c = 600,
                    d = [],
                    f, p, h, m, g = 0;
                for (n = n || 0, i = i || 0, o = o || P.width, a = a || P.height, u = i; a > u; u += c)
                    ...
                    for (u = Math.round(Math.sqrt(e.length)), c = Math.floor(u / 2), f = n; r > f; f++)
                        for (d = t; i > d; d++) {
                            for (p = h = m = 0, v = 0; u > v; v++)
                                for (g = 0; u > g; g++) y = d + g - c, x = f + v - c, y = 0 > y ? 0 : y > a ? a : y, x = 0 > x ? 0 : x > s ? s : x, b = 4 * (x * a + y), w = e[v * u + g], p += o[b] * w, h += o[b + 1] * w, m += o[b + 2] * w;
                        ...
                        for (u = n; r > u; u++)
                            for (l = t; i > l; l++) {
                                for (m = f = p = h = 0, v = -1; 2 > v; v++)
                                    for (g = -1; 2 > g; g++) y = l + g, x = u + v, y = 0 > y ? 0 : y > a ? a : y, x = 0 > x ? 0 : x > s ? s : x, d = 4 * (x * a + y), f += o[d], p += o[d + 1], h += o[d + 2], m++;
        ...
        var e = function(e) {
            ...
            i = function(e, n) {
                ...
                if (e) {
                    ...
                    if (i === t) {
                        for (r in e)
                            if (e.hasOwnProperty(r) && n(e[r], r) === !1) return
                    } else
                        for (o = 0; i > o; o++)
                            if (n(e[o], o) === !1) return
                }
        ...
        return r.getRuntime = function(e) {
            ...
            if ("string" === e.typeOf(i) && o === t && (i = function(t) {
                ...
                for (var a in i)
                    if (!r.can.call(this, n, a, i[a])) return !1;
                return !0
            }
        ...
        function f() {
                ...
                G = g, X = y(), X.onreadystatechange = function r() {
                    switch (i("readyState") > f.HEADERS_RECEIVED && (i("status", X.status), i("statusText", X.statusText)), i("readyState", X.readyState), t.dispatchEvent("readystatechange"), i("readyState")) {
                        ...
                        case f.LOADING:
                            ...
                            break;
                        case f.DONE:
                            X.onreadystatechange = function() {}, 0 === X.status ? (W = !0, t.dispatchEvent("error")) : (i("responseText", X.responseText), i("responseXML", x(X)), i("response", "document" === i("responseType") ? i("responseXML") : i("responseText")), t.dispatchEvent("load")), X = null, t.dispatchEvent("loadend")
                    }
            ...
            function w(t) {
                ...
                var o = this;
                G = v, X = new a, V.required_caps = e.extend({}, V.required_caps, {
                    return_response_type: o.responseType
                }), V.ruid ? r(X.connectRuntime(V)) : (X.bind("RuntimeInit", function(e, t) {
                    r(t)
                }), X.connectRuntime(V))
            }
            ...
            e.extend(this, T, {
                ...
                send: function(t, i) {
                    var o = this;
                    if (V = "string" === e.typeOf(i) ? {
                            ruid: i
                        } : i ? i : {}, this.convertEventPropsToHandlers(m), this.upload.convertEventPropsToHandlers(m), this.readyState !== f.OPENED || O) throw new n.DOMException(n.DOMException.INVALID_STATE_ERR);
                    if (!E())
                        if (t instanceof s) V.ruid = t.ruid, H = t.type;
                ...
                abort: function() {
                    var t;
                    if (W = !0, N = !1, ~e.inArray(i("readyState"), [f.UNSENT, f.OPENED, f.DONE])) i("readyState", f.UNSENT);
                    else {
                        if (i("readyState", f.DONE), O = !1, G === g) X.abort(), this.dispatchEvent("readystatechange"), this.dispatchEvent("abort"), this.dispatchEvent("loadend"), L || (this.upload.dispatchEvent("abort"), this.upload.dispatchEvent("loadend"));
                        else {
        ...
        return e.extend({
            ...
            init: function(e) {
                ...
                t._super(e), t.on("click", function(e) {
                    var r, o, a;
                    if (-1 != e.target.className.indexOf("checkbox")) a = e.target.parentNode.parentNode, o = i.inArray(a, a.parentNode.childNodes), r = !t.isSelected(o), t.setRowState(o, o, r);
                    else if (n.hasClass(e.target, "moxman-thumb")) {
            ...
            update: function() {
                ...
                var t = this,
                    ...
                    l = t.classPrefix;
                if (t.visible()) {
                    for (a = t.fire("beforeUpdate", {
                            data: a
                        }).data, i = 0; a.length > i; i++) {
                        o = a[i];
                        var u = {
                            row: o
                        };
        ...
        var h = document,
            ...
            v = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/,
            y = a("fillOpacity fontWeight lineHeight opacity orphans widows zIndex zoom"),
        ...
        function l(t, n, i, r, o) {
            return g(2, arguments), e(t, function(t) {
                ...
                if (y = t.length >>> 0, u = Math.max(0, Math.min(n, y)), d = [], c = y - u + 1, f = [], p = a(), u)
                    for (g = p.progress, m = function(e) {
                            f.push(e), --c || (h = m = v, p.reject(f))
                        }, h = function(e) {
                            d.push(e), --u || (h = m = v, p.resolve(d))
                        }, x = 0; y > x; ++x) x in t && e(t[x], l, s, g);
                else p.resolve(d);
                ...
                function c() {
                    b.saveAs(x.find("#saveas").value(), function(t) {
                        r.convertResult(t, function(t) {
                            x.close(), l(e, t), e.onsave && e.onsave({
                                file: t
                            })
                        })
                    }, function(e) {
        ...
        return e.extend({
            ...
            renderAsDialog: function(p) {
                ...
                function Q(e) {
                    ...
                    }), (t = ut["createdoc.templates"]) && (n.append({
                        text: "-"
                ...
                function nt(e) {
                    var t = e.control.menu,
                        n = ct.fire("BeforeRenderManageMenu", {
                            menu: t
                        });
                    ...
                    f.getConfig(function(f) {
                        function p(e) {
                            for (var t = s.extname(e).substr(1), n = 0; b.length > n; n++)
                                if ("*" == b[n] || b[n] == t.toLowerCase()) return !0;
                            return !1
                        }

                        function h(e) {
                            var t, n = S.find("#dragmsg"),
                                i = S.find("#files")[0],
                                r = 0,
                                o;

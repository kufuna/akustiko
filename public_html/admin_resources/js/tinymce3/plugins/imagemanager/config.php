<?php
        ...
        $mcImageManagerConfig['filesystem.rootpath'] = '../../../../../uploads/tinymce'; // absolute or relative from this script path, required.
        ...
        $mcImageManagerConfig['SessionAuthenticator.logged_in_key'] = "isLoggedIn"; // The name of the session to check for "true" in
        $mcImageManagerConfig['SessionAuthenticator.groups_key'] = "groups";
        $mcImageManagerConfig['SessionAuthenticator.user_key'] = "tinymce_plugin_user";

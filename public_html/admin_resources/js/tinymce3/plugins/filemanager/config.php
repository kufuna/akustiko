<?php
        ...
        $mcFileManagerConfig['filesystem.rootpath'] = '../../../../../uploads/tinymce/files/'; // absolute or relative from this script path.
        ...
        $mcFileManagerConfig['filesystem.extensions'] = "doc,docx,gif,jpg,htm,html,pdf,zip,txt,php,png,swf,dcr,mov,qt,ram,rm,avi,mp3,mpg,mpeg,asf,flv,xls";
        ...
        $mcFileManagerConfig['upload.extensions'] = "gif,jpg,mp3,png,pdf,zip,doc,docx,xls";
        ...
        $mcFileManagerConfig['download.extensions'] = "gif,jpg,htm,html,mp3,pdf,txt,zip,doc,docx";
        ...
        // Authenication
        $mcFileManagerConfig['authenticator'] = "SessionAuthenticator"; // Tell it to use the session authenticator
        $mcFileManagerConfig['authenticator.login_page'] = "login_session_auth.php"; // <- URL to your login page if the user couldn't be verifie        
        //$mcFileManagerConfig['authenticator.allow_override'] = "*";

        // SessionAuthenticator
        $mcFileManagerConfig['SessionAuthenticator.logged_in_key'] = "isLoggedIn"; // The name of the session to check for "true" in
